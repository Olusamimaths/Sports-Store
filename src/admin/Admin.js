...
import { OrdersConnector } from './components/OrdersConnector';
import { Route, Redirect, Switch} from 'react-router-dom';
import { ToggleLink } from '../ToggleLink';
import { ConnectedProducts } from './components/ProductsConnector';
            ...
            <div className='container-fluid'>
                ...
                <div className='row'>
                    ...
                    <div className='col-9 p-2'>
                        ...
                        {
                            !this.props.isAuthenticated && 
                            // route without a path will always be displayed and prevents
